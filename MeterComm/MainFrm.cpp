...
BEGIN_MESSAGE_MAP(CMainFrame, CFrameWndEx)
	...
	ON_COMMAND_RANGE(ID_INDICATOR_COMINFO, ID_INDICATOR_TIME, NULL)
END_MESSAGE_MAP()
...
int CMainFrame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	m_wndStatusBar.SetPaneTextColor(4, RGB(255,0,0));
	...
	lstBasicCommands.AddTail(ID_SETTING_COMPORT);
	lstBasicCommands.AddTail(ID_SETTING_PARAMETER);
	lstBasicCommands.AddTail(ID_SETTING_NETWORK);
	...
	lstBasicCommands.AddTail(ID_TOOL_DECODE698);
...
void CMainFrame::OnTimer(UINT_PTR nIDEvent)
{
	...
	case 1:
		...
		m_wndStatusBar.SetPaneText(5, strTime);
		m_wndStatusBar.SetPaneTextColor(5, RGB(0,0,0));
		break;
	}
...
afx_msg LRESULT CMainFrame::OnMsgrecvpro(WPARAM wParam, LPARAM lParam)
{
	...
	case MSGUSER_PORTOPEN:
		{
			...
			m_wndStatusBar.SetPaneWidth(4,300-6*(41-p_str->GetLength()));
			m_wndStatusBar.SetPaneText(4, *p_str);
			m_wndStatusBar.SetPaneTextColor(4, RGB(0,0,0));
	...
	case MSGUSER_PORTCLOSE:
		{
			CString * p_str=(CString *)wParam;
			m_wndStatusBar.SetPaneWidth(4,60);
			m_wndStatusBar.SetPaneText(4, *p_str);
			m_wndStatusBar.SetPaneTextColor(4, RGB(255,0,0));
		}
		break;
